...
@section('title', 'Декор из маршмеллоу')
...
@section('content')
    ...
    <nav class="mt-2" aria-label="breadcrumb">
        <ol class="breadcrumb white pl-5">
            ...
            <li class="breadcrumb-item"><a class="text-dark" href="">Декор из маршмеллоу</a></li>
    ...
    <div class="row ml-5 mr-5">
        ...
        <div class="col mb-5">
            @include('include.nav_asside_marshm')
        </div>
                        ...
                        <ul class="nav justify-content-end py-1">
                            <li class="nav-item">
                                ...
                                <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
                                    <a class="dropdown-item" href="{{ route('tovarsmarshm', ['categ' => session('category'), 'pole' => 'code', 'sort' => 'asc', 'title' => session('title')]) }}">По умолчанию</a>
                                    <a class="dropdown-item" href="{{ route('tovarsmarshm', ['categ' => session('category'), 'pole' => 'price', 'sort' => 'asc', 'title' => session('title')]) }}">По возрастанию цены</a>
                                    <a class="dropdown-item" href="{{ route('tovarsmarshm', ['categ' => session('category'), 'pole' => 'price', 'sort' => 'desc', 'title' => session('title')]) }}">По убыванию цены</a>
                                </div>
                            </li>
                        </ul>
                        <br>
